...
class Xss {
    ...
    public function entity_decode($str, $charset = NULL)
    {
        ...
        do
        {
            ...
            $str = preg_replace_callback('~&#x(0*[0-9a-f]{2,5})~i', function($r) { return chr(hexdec($r[1])); }, $str, -1, $matches);
            $str = preg_replace_callback('~&#([0-9]{2,4})~', function($r) { return chr($r[1]); }, $str, -1, $matches1);
        }
