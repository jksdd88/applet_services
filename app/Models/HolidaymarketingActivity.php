...
class HolidaymarketingActivity extends Model
{

    protected $table = 'holiday_marketing_activity';
    ...
    static function get_data_by_id($id, $fields = '*') {
        ...
        $key = CacheKey::get_holiday_marketing_activity_by_id($id);
        $data = Cache::get($key);
        if(!$data) {
