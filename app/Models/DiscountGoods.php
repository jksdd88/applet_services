...
class DiscountGoods extends Model {
    ...
    protected $table = 'discount_goods';
    protected $guarded = ['id'];

    function tags() {
        return $this->belongsToMany('App\Models\GoodsTag', 'goods_tag_rs', 'goods_id', 'tag_id');
    }
    ...
    public function discountActivity(){
        return $this->belongsTo(DiscountActivity::class,'discount_id');
    }
