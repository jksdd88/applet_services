...
class GoodsGroupController extends Controller
{
    ...
    public function delete()
    {
        ...
        //查询改分组下是否有商品
        $where_goods[] = array('column' => 'merchant_id', 'value' => $this->merchant_id, 'operator' => '=');
        $where_goods[] = array('column' => 'tag_id', 'value' => $id, 'operator' => '=');
//        $count = $this->goods_tag_rs->get_data_count($where_goods);
        $count = GoodsTagRs::where('goods_tag_rs.merchant_id', $this->merchant_id)
    ...
    public function add()
    {
        ...
        $insert_data['merchant_id'] = $this->merchant_id;
    ...
    public function detail()
    {
        ...
        $data['data'] = $query->select(array('id', 'title', 'created_time', 'updated_time'))->first();
        $data['errcode'] = 0;
        $data['errmsg'] = '';
        return Response::json($data);
    }
